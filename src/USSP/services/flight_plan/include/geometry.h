...
#ifndef USSP_GEOMETRY_H_
#define USSP_GEOMETRY_H_
...
class USSP_EXPORT Geometry {
 public:
  ...
  template <Type tag>
  struct USSP_EXPORT CoordinateVector {
 ...
 private:
  struct USSP_EXPORT Invalid {};

  union USSP_EXPORT Data {
    Data();
    ~Data();
...
/// @cond
USSP_EXPORT bool operator==(const Geometry::Coordinate& lhs, const Geometry::Coordinate& rhs);

USSP_EXPORT bool operator==(const Geometry::Polygon& lhs, const Geometry::Polygon& rhs);

template <Geometry::Type tag>
USSP_EXPORT inline bool operator==(const Geometry::CoordinateVector<tag>& lhs,
