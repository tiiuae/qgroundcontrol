...
#ifndef USSP_ERROR_H_
#define USSP_ERROR_H_
...
/// Error models an error raised by an USSP component.
struct USSP_EXPORT Error {
...
USSP_EXPORT bool operator==(const Error::Value& lhs, const Error::Value& rhs);
/// operator< returns true if type and value of lhs compare < than type and value of rhs.
USSP_EXPORT bool operator<(const Error::Value& lhs, const Error::Value& rhs);
/// operator<< inserts 'value' into 'out'.
USSP_EXPORT std::ostream& operator<<(std::ostream& out, const Error::Value& value);
/// operator<< inserts 'error' into 'out'.
USSP_EXPORT std::ostream& operator<<(std::ostream& out, const Error& error);
