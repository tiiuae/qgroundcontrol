...
#ifndef USSP_FLIGHT_PLAN_H_
#define USSP_FLIGHT_PLAN_H_
...
struct USSP_EXPORT FlightPlan {
  /// Id models a unique identifier for a flight plan in the context of USSP.
  using Id = std::string;
  ...
  struct USSP_EXPORT Briefing {
    ...
    DateTime created_at;      ///< The timestamp when the briefing was requested and created by the USSP services.
  ...
  Id id;                            ///< The unique identifier of a flight in the context of USSP.
