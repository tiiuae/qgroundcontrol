...
#ifndef USSP_EVALUATION_H_
#define USSP_EVALUATION_H_
...
struct USSP_EXPORT Evaluation {
  ...
  struct USSP_EXPORT Authorization {
...
/// @cond
USSP_EXPORT std::ostream& operator<<(std::ostream& out, Evaluation::Authorization::Status status);
USSP_EXPORT std::istream& operator>>(std::istream& in, Evaluation::Authorization::Status& status);

USSP_EXPORT std::ostream& operator<<(std::ostream& out, Evaluation::Validation::Status status);
USSP_EXPORT std::istream& operator>>(std::istream& in, Evaluation::Validation::Status& status);

USSP_EXPORT std::ostream& operator<<(std::ostream& out, Evaluation::Failure failure);
USSP_EXPORT std::istream& operator>>(std::istream& in, Evaluation::Failure& failure);
/// @endcond

}  // namespace ussp

#endif  // USSP_EVALUATION_H_
