...
#ifndef USSP_STATUS_H_
#define USSP_STATUS_H_

#include <include/airspace.h>
#include <include/date_time.h>
#include <include/do_not_copy_or_move.h>
...
/// a geographic area.
class USSP_EXPORT Status : DoNotCopyOrMove {
 public:
...
/// @cond
USSP_EXPORT std::ostream& operator<<(std::ostream& out, Status::Color color);
USSP_EXPORT std::istream& operator>>(std::istream& in, Status::Color& color);
/// @endcond

}  // namespace ussp

#endif  // USSP_STATUS_H_
